...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return createPool; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return dbConfig; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return getConnection; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_oracledb__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_oracledb___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_oracledb__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_es6_promise__ = __webpack_require__(83);
...
const Promise = __WEBPACK_IMPORTED_MODULE_2_es6_promise___default.a.Promise;
let pool;
...
let dbConfig = {
  ...
  let orclDbPool = new Promise(function (resolve, reject) {
    __WEBPACK_IMPORTED_MODULE_0_oracledb___default.a.createPool(dbConfig, (err, p) => {
...
async function doExecute(connection, sql, params) {
  ...
  let promise = new Promise((resolve, reject) => {
    connection.execute(sql, params, { autoCommit: isCommit, outFormat: __WEBPACK_IMPORTED_MODULE_0_oracledb___default.a.OBJECT, maxRows: 1000 }, (err, result) => {
      if (err) {
        reject(err);
      } else {
        resolve(result);
...
var typer = __webpack_require__(43)
...
var statuses = __webpack_require__(2)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__schema__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__db_database__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__token__ = __webpack_require__(21);
...
async function isAuthorized(request) {
  ...
  const { error, value } = __WEBPACK_IMPORTED_MODULE_0_joi___default.a.validate(request, __WEBPACK_IMPORTED_MODULE_1__schema__["a" /* default */]);
  let result = false;
  if (error) return false;

  const authParamFromDb = await Object(__WEBPACK_IMPORTED_MODULE_2__db_database__["c" /* getConnection */])('select id, get_hash(:password) providedPassword,  p_password ' + 'from ref_users ' + 'where p_password  = get_hash(:password)', [value.password]);
...
async function hasValidRefreshToken(token) {
  const { username } = await __WEBPACK_IMPORTED_MODULE_3__token__["a" /* default */].getPayload(token);
  const refreshToken = await Object(__WEBPACK_IMPORTED_MODULE_2__db_database__["c" /* getConnection */])('select refresh_token ' + ' from ref_users ' + ' where p_username = :username ', [username.username]);
  return refreshToken.rows[0].REFRESH_TOKEN;
}

/* harmony default export */ __webpack_exports__["a"] = ({ isAuthorized, hasValidRefreshToken });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jsonwebtoken__ = __webpack_require__(88);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_bluebird__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_bluebird___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_bluebird__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_dotenv__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__db_database__ = __webpack_require__(9);
...
__WEBPACK_IMPORTED_MODULE_1_bluebird___default.a.promisifyAll(__WEBPACK_IMPORTED_MODULE_0_jsonwebtoken___default.a);

async function generateTokens(username) {
  const accessToken = __WEBPACK_IMPORTED_MODULE_0_jsonwebtoken___default.a.sign({ username }, key, { expiresIn: '10m' });
  const refreshToken = __WEBPACK_IMPORTED_MODULE_0_jsonwebtoken___default.a.sign({ username }, key, { expiresIn: '30d' });
  Object(__WEBPACK_IMPORTED_MODULE_4__db_database__["c" /* getConnection */])('update ref_users ' + 'set access_token = :accessToken, ' + 'refresh_token = :refreshToken ' + 'where p_username =:username ', [accessToken, refreshToken, username.username]);
  const tokens = {
    accessToken,
    refreshToken,
    expiresIn: __WEBPACK_IMPORTED_MODULE_0_jsonwebtoken___default.a.decode(accessToken).exp
  };
...
async function getPayload(token) {
  try {
    const payload = await __WEBPACK_IMPORTED_MODULE_0_jsonwebtoken___default.a.verifyAsync(token, key);
    return payload;
  } catch (e) {
...
/* harmony default export */ __webpack_exports__["a"] = ({ generateTokens, getPayload });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_Koa__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_Koa___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_Koa__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_koa_morgan__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_dotenv__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_dotenv___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_dotenv__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bluebird__ = __webpack_require__(8);
...
let pool = Object(__WEBPACK_IMPORTED_MODULE_4__db_database__["a" /* createPool */])(__WEBPACK_IMPORTED_MODULE_4__db_database__["b" /* dbConfig */]);
let queryResult;
pool.then(() => {
    server.use(__WEBPACK_IMPORTED_MODULE_1_koa_morgan___default()('tiny')).use(__WEBPACK_IMPORTED_MODULE_5__router__["a" /* default */].routes()).use(__WEBPACK_IMPORTED_MODULE_5__router__["a" /* default */].allowedMethods()).listen(port, () => {
...
const ensureErrorHandler = __webpack_require__(37);
const getType = __webpack_require__(38);
const onFinish = __webpack_require__(11);
const isJSON = __webpack_require__(12);
const escape = __webpack_require__(42);
const typeis = __webpack_require__(13).is;
const statuses = __webpack_require__(2);
const destroy = __webpack_require__(45);
...
const mimeTypes = __webpack_require__(4);
const LRU = __webpack_require__(41);
...
var ReadStream = __webpack_require__(46).ReadStream
var Stream = __webpack_require__(3)
...
const statuses = __webpack_require__(2);
const Cookies = __webpack_require__(62);
...
var deprecate = __webpack_require__(6)('cookies')
var Keygrip = __webpack_require__(63)
...
const URL = __webpack_require__(7).URL;
const net = __webpack_require__(66);
const accepts = __webpack_require__(67);
const contentType = __webpack_require__(73);
const stringify = __webpack_require__(7).format;
const parse = __webpack_require__(74);
const qs = __webpack_require__(75);
const typeis = __webpack_require__(13);
const fresh = __webpack_require__(76);
const only = __webpack_require__(5);
const util = __webpack_require__(0);
...
const co = __webpack_require__(78)
...
const Promise = __webpack_require__(80)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_koa_router__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_koa_router___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_koa_router__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_koa_bodyparser__ = __webpack_require__(86);
...
router.post('/', __WEBPACK_IMPORTED_MODULE_1_koa_bodyparser___default()(), async ctx => {
  const isAuthorized = await __WEBPACK_IMPORTED_MODULE_2__user__["a" /* default */].isAuthorized(ctx.request.body);
  ctx.status = 404;

  if (isAuthorized) {
    const tokens = await __WEBPACK_IMPORTED_MODULE_3__token__["a" /* default */].generateTokens(ctx.request.body);
    ctx.status = 200;
    ctx.body = tokens;
  };
});
...
router.get('/', async ctx => {
  ...
  const { username } = await __WEBPACK_IMPORTED_MODULE_3__token__["a" /* default */].getPayload(refreshToken);
  const hasValidRefreshToken = await __WEBPACK_IMPORTED_MODULE_2__user__["a" /* default */].hasValidRefreshToken(refreshToken);
...
const schema = __WEBPACK_IMPORTED_MODULE_0_joi___default.a.object().keys({
  username: __WEBPACK_IMPORTED_MODULE_0_joi___default.a.string().min(4).max(24).alphanum().required(),
  password: __WEBPACK_IMPORTED_MODULE_0_joi___default.a.string().min(4).max(64).required()
});
